...
async function renderizarMesGrid(desde, hasta, ano, mesIdx, columnasArg = window.columnas, bloquesArg = null) {
    ...
    // Usa los bloques filtrados si se pasan, si no, usa la función original que los obtiene todos
    const bloques = bloquesArg || await obtenerBloquesHorarios(agrupacionGlobalId, desde, hasta);
    ...
    diasMes.forEach(fechaISO => {
        ...
        inicializarMiniCalendarioEditable(calId, fechaISO, columnasArg, eventosDia);
    });
